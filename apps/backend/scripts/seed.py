...
ZONES = [
    ...
    {
        "id": "vol_post_1",
        "name": "Volunteer Post 1",
        "zone_type": ZoneType.volunteer_post,
        "capacity": 20,
        "x": 290,
        "y": 155,
        "w": 50,
...
INCIDENTS = [
    {
        ...
        "description": "Large queue forming at Gate A entry checkpoint — estimated 400 fans in queue.",
        "severity": IncidentSeverity.high,
        "ai_severity_score": 0.82,
    },
    {
        "zone_id": "concourse_north",
        "title": "Food vendor spill",
        "description": "Slip hazard near kiosk 3 on North Concourse. Area cordoned but crowd building.",
    ...
    },
    {
        ...
        "description": "Fan reported dizziness in Section 102, row 14. Medical team en route.",
        "severity": IncidentSeverity.critical,
        "ai_severity_score": 0.95,
    },
    {
        "zone_id": "parking_p1",
        "title": "Unauthorised vehicle P1",
        "description": "Vehicle blocking emergency lane in P1. Security alerted.",
        "severity": IncidentSeverity.medium,
        "ai_severity_score": 0.60,
    },
    {
        "zone_id": "section_120",
        "title": "Lost child reported",
        "description": "Child separated from guardian near Section 120. Volunteer and security notified.",
        "severity": IncidentSeverity.high,
